...
std::ostream &operator<<( std::ostream &os, const MoodysAnalysis &entity ) {
	return os << "MoodysAnalysis("  << "sourceFed:" << entity.get_sourceFed() << ", " << "originFed:" << entity.get_originFed() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
