...
std::ostream &operator<<( std::ostream &os, const IndianTransferReceipt &entity ) {
	return os << "IndianTransferReceipt("  << "id:" << entity.get_id() << ", " << "sourceFed:" << entity.get_sourceFed() << ", " << "originFed:" << entity.get_originFed() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
