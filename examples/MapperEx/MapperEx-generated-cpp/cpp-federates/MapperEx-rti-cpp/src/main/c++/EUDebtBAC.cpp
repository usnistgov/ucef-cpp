...
std::ostream &operator<<( std::ostream &os, const EUDebtBAC &entity ) {
	return os << "EUDebtBAC("  << "sourceFed:" << entity.get_sourceFed() << ", " << "debtInBillionUSDs:" << entity.get_debtInBillionUSDs() << ", " << "originFed:" << entity.get_originFed() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
