...
std::ostream &operator<<( std::ostream &os, const USMoneyGram &entity ) {
	return os << "USMoneyGram("  << "dollars:" << entity.get_dollars() << ", " << "sourceFed:" << entity.get_sourceFed() << ", " << "receiver:" << entity.get_receiver() << ", " << "originFed:" << entity.get_originFed() << ", " << "sender:" << entity.get_sender() << ", " << "id:" << entity.get_id() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
