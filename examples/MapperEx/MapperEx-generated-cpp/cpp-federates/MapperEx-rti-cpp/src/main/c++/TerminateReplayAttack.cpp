...
void TerminateReplayAttack::init( RTI::RTIambassador *rti ) {
	...
	while( isNotInitialized ) {
		try {
			getHandle() = rti->getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack" );
	...
	getClassNameHandleMap().insert(  std::make_pair( "TerminateReplayAttack", get_handle() )  );
	getClassHandleNameMap().insert(  std::make_pair( get_handle(), "TerminateReplayAttack" )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "TerminateReplayAttack,dstNetworkAddress", get_dstNetworkAddress_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "TerminateReplayAttack,srcNetworkAddress", get_srcNetworkAddress_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "TerminateReplayAttack,recordingNodeFullPath", get_recordingNodeFullPath_handle() )  );
...
void TerminateReplayAttack::publish( RTI::RTIambassador *rti ) {
	if ( getIsPublished() ) {
		return;
	}
...
void TerminateReplayAttack::unpublish( RTI::RTIambassador *rti ) {
	if ( !getIsPublished() ) {
		return;
	}
...
void TerminateReplayAttack::subscribe( RTI::RTIambassador *rti ) {
	if ( getIsSubscribed() ) {
		return;
	}
...
void TerminateReplayAttack::unsubscribe( RTI::RTIambassador *rti ) {
	if ( !getIsSubscribed() ) {
		return;
	}
...
bool TerminateReplayAttack::static_init( void ) {
	static bool isInitialized = false;
	if ( isInitialized ) {
		return true;
	}
	...
	getClassNameSet().insert( "TerminateReplayAttack" );
	
	getClassNameFactoryMap().insert(  std::make_pair( "TerminateReplayAttack", &TerminateReplayAttack::factory )  );
	getClassNamePublishMap().insert(   std::make_pair(  "TerminateReplayAttack", (PubsubFunctionPtr)( &TerminateReplayAttack::publish )  )   );
	getClassNameUnpublishMap().insert(   std::make_pair(  "TerminateReplayAttack", (PubsubFunctionPtr)( &TerminateReplayAttack::unpublish )  )   );
	getClassNameSubscribeMap().insert(   std::make_pair(  "TerminateReplayAttack", (PubsubFunctionPtr)( &TerminateReplayAttack::subscribe )  )   );
	getClassNameUnsubscribeMap().insert(   std::make_pair(  "TerminateReplayAttack", (PubsubFunctionPtr)( &TerminateReplayAttack::unsubscribe )  )   );

	getDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "TerminateReplayAttack", &getDatamemberNames() )  );
	getAllDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "TerminateReplayAttack", &getAllDatamemberNames() )  );
...
TerminateReplayAttack::ParameterHandleValuePairSetSP TerminateReplayAttack::createDatamemberHandleValuePairSet( RTI::ULong count ) {
