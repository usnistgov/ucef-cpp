...
std::ostream &operator<<( std::ostream &os, const StandardAndPoorsAnalysis &entity ) {
	return os << "StandardAndPoorsAnalysis("  << "sourceFed:" << entity.get_sourceFed() << ", " << "originFed:" << entity.get_originFed() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
