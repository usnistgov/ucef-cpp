...
void EUDebtSG::init( RTI::RTIambassador *rti ) {
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "EUDebtSG,debtInBillionUSDs", get_debtInBillionUSDs_handle() )  );
...
std::ostream &operator<<( std::ostream &os, const EUDebtSG &entity ) {
	return os << "EUDebtSG("  << "sourceFed:" << entity.get_sourceFed() << ", " << "originFed:" << entity.get_originFed() << ", " << "debtInBillionUSDs:" << entity.get_debtInBillionUSDs() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
