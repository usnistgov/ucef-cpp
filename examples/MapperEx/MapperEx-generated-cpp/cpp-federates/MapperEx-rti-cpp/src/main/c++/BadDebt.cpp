...
std::ostream &operator<<( std::ostream &os, const BadDebt &entity ) {
	return os << "BadDebt("  << "writeOffBank:" << entity.get_writeOffBank() << ", " << "sourceFed:" << entity.get_sourceFed() << ", " << "dollarsInBillionUSDs:" << entity.get_dollarsInBillionUSDs() << ", " << "originFed:" << entity.get_originFed() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
