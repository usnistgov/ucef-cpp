...
std::ostream &operator<<( std::ostream &os, const EUMoneyGram &entity ) {
	return os << "EUMoneyGram("  << "euros:" << entity.get_euros() << ", " << "sourceFed:" << entity.get_sourceFed() << ", " << "receiver:" << entity.get_receiver() << ", " << "originFed:" << entity.get_originFed() << ", " << "sender:" << entity.get_sender() << ", " << "id:" << entity.get_id() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
