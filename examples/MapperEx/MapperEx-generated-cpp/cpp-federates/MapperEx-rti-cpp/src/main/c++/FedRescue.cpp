...
std::ostream &operator<<( std::ostream &os, const FedRescue &entity ) {
	return os << "FedRescue("  << "sourceFed:" << entity.get_sourceFed() << ", " << "dollarsInBillionUSDs:" << entity.get_dollarsInBillionUSDs() << ", " << "receiver:" << entity.get_receiver() << ", " << "originFed:" << entity.get_originFed() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
