...
std::ostream &operator<<( std::ostream &os, const USTransferReceipt &entity ) {
	return os << "USTransferReceipt("  << "sourceFed:" << entity.get_sourceFed() << ", " << "originFed:" << entity.get_originFed() << ", " << "id:" << entity.get_id() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
