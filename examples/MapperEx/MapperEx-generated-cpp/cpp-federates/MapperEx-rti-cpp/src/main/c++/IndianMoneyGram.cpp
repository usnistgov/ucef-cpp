...
std::ostream &operator<<( std::ostream &os, const IndianMoneyGram &entity ) {
	return os << "IndianMoneyGram("  << "rupees:" << entity.get_rupees() << ", " << "sourceFed:" << entity.get_sourceFed() << ", " << "receiver:" << entity.get_receiver() << ", " << "originFed:" << entity.get_originFed() << ", " << "sender:" << entity.get_sender() << ", " << "id:" << entity.get_id() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
