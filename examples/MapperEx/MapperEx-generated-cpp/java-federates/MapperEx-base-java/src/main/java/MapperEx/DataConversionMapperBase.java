...
public class DataConversionMapperBase extends SynchronizedFederate {
	...
	// constructor
	public DataConversionMapperBase( String federation_id, String federate_id ) throws Exception {
       ...
       // constructor
	public DataConversionMapperBase(  String[] federationInfo ) throws Exception {
