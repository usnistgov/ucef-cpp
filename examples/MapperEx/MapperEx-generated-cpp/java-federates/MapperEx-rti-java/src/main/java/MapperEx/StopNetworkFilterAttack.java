...
/**
* The StopNetworkFilterAttack class implements the StopNetworkFilterAttack interaction in the
* MapperEx simulation.
*/
public class StopNetworkFilterAttack extends OmnetCommand {

	/**
	* Default constructor -- creates an instance of the StopNetworkFilterAttack interaction
	* class with default parameter values.
	*/
	public StopNetworkFilterAttack() { }
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the StopNetworkFilterAttack interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the StopNetworkFilterAttack
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the StopNetworkFilterAttack interaction class.
	*/
	public static String get_simple_class_name() { return "StopNetworkFilterAttack"; }
	...
	* StopNetworkFilterAttack interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack" );
		_classNameClassMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack", StopNetworkFilterAttack.class );
		
		_datamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack", _datamemberNames );
		_allDatamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack", _allDatamemberNames );
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack:  could not initialize:  ";
	protected static void init( RTIambassador rti ) {
		...
		while( isNotInitialized ) {
			try {
				_handle = rti.getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack" );
		...
		_classNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack", get_handle() );
		_classHandleNameMap.put( get_handle(), "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack" );
		_classHandleSimpleNameMap.put( get_handle(), "StopNetworkFilterAttack" );
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack,dstNetworkAddress", get_dstNetworkAddress_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack,srcNetworkAddress", get_srcNetworkAddress_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack,recordingNodeFullPath", get_recordingNodeFullPath_handle() );
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack:  could not publish:  ";

	/**
	* Publishes the StopNetworkFilterAttack interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack:  could not unpublish:  ";
	/**
	* Unpublishes the StopNetworkFilterAttack interaction class for a federate.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack:  could not subscribe:  ";
	/**
	* Subscribes a federate to the StopNetworkFilterAttack interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkFilterAttack:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the StopNetworkFilterAttack interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	* (that is, the StopNetworkFilterAttack interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the StopNetworkFilterAttack interaction class).
	...
	*/
	...
	public String toString() {
		return "StopNetworkFilterAttack("
	...
	*/
	...
	protected StopNetworkFilterAttack( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected StopNetworkFilterAttack( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the StopNetworkFilterAttack interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new StopNetworkFilterAttack interaction class instance
	*/
	public StopNetworkFilterAttack( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #StopNetworkFilterAttack( ReceivedInteraction datamemberMap )}, except this
	* new StopNetworkFilterAttack interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new StopNetworkFilterAttack interaction class instance
	* @param logicalTime timestamp for this new StopNetworkFilterAttack interaction class
	* instance
	*/
	public StopNetworkFilterAttack( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new StopNetworkFilterAttack interaction class instance that is a duplicate
	* of the instance referred to by StopNetworkFilterAttack_var.
	*
	* @param StopNetworkFilterAttack_var StopNetworkFilterAttack interaction class instance of which
	* this newly created StopNetworkFilterAttack interaction class instance will be a
	* duplicate
	*/
	public StopNetworkFilterAttack( StopNetworkFilterAttack StopNetworkFilterAttack_var ) {
		super( StopNetworkFilterAttack_var );
		
		
		set_dstNetworkAddress( StopNetworkFilterAttack_var.get_dstNetworkAddress() );
		set_srcNetworkAddress( StopNetworkFilterAttack_var.get_srcNetworkAddress() );
		set_recordingNodeFullPath( StopNetworkFilterAttack_var.get_recordingNodeFullPath() );
	}
	...
	*/
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof StopNetworkFilterAttack ) {
			StopNetworkFilterAttack data = (StopNetworkFilterAttack)object;
