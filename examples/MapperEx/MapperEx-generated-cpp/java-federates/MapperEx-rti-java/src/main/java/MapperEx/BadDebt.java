...
public class BadDebt extends C2WInteractionRoot {
	...
	*/
	public Object getParameter( String datamemberName ) {
		...
		if (  "writeOffBank".equals( datamemberName )  ) return get_writeOffBank();
		else if (  "dollarsInBillionUSDs".equals( datamemberName )  ) return new Integer( get_dollarsInBillionUSDs() );
	...
	*/
	public Object getParameter( int datamemberHandle ) {
		...
		if ( get_writeOffBank_handle() == datamemberHandle ) return get_writeOffBank();
		else if ( get_dollarsInBillionUSDs_handle() == datamemberHandle ) return new Integer( get_dollarsInBillionUSDs() );
	...
	protected boolean setParameterAux( int param_handle, String val ) {
		...
		if ( param_handle == get_writeOffBank_handle() ) set_writeOffBank( val );
		else if ( param_handle == get_dollarsInBillionUSDs_handle() ) set_dollarsInBillionUSDs( Integer.parseInt( val ) );
	...
	protected boolean setParameterAux( String datamemberName, String val ) {
		...
		if (  "writeOffBank".equals( datamemberName )  ) set_writeOffBank( val );
		else if (  "dollarsInBillionUSDs".equals( datamemberName )  ) set_dollarsInBillionUSDs( Integer.parseInt( val ) );	
	...
	protected boolean setParameterAux( String datamemberName, Object val ) {
		...
		if (  "writeOffBank".equals( datamemberName )  ) set_writeOffBank( (String)val );
		else if (  "dollarsInBillionUSDs".equals( datamemberName )  ) set_dollarsInBillionUSDs( (Integer)val );		
		else retval = super.setParameterAux( datamemberName, val );
