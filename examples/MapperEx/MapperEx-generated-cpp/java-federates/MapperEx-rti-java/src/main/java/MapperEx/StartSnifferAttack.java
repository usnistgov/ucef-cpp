...
/**
* The StartSnifferAttack class implements the StartSnifferAttack interaction in the
* MapperEx simulation.
*/
public class StartSnifferAttack extends OmnetCommand {

	/**
	* Default constructor -- creates an instance of the StartSnifferAttack interaction
	* class with default parameter values.
	*/
	public StartSnifferAttack() { }
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the StartSnifferAttack interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the StartSnifferAttack
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the StartSnifferAttack interaction class.
	*/
	public static String get_simple_class_name() { return "StartSnifferAttack"; }
	...
	* StartSnifferAttack interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack" );
		_classNameClassMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack", StartSnifferAttack.class );
		
		_datamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack", _datamemberNames );
		_allDatamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack", _allDatamemberNames );
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack:  could not initialize:  ";
	protected static void init( RTIambassador rti ) {
		...
		while( isNotInitialized ) {
			try {
				_handle = rti.getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack" );
		...
		_classNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack", get_handle() );
		_classHandleNameMap.put( get_handle(), "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack" );
		_classHandleSimpleNameMap.put( get_handle(), "StartSnifferAttack" );
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack,listenerNodeFullPath", get_listenerNodeFullPath_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack,listenerInterface", get_listenerInterface_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack,nodeFullPath", get_nodeFullPath_handle() );
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack:  could not publish:  ";

	/**
	* Publishes the StartSnifferAttack interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack:  could not unpublish:  ";
	/**
	* Unpublishes the StartSnifferAttack interaction class for a federate.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack:  could not subscribe:  ";
	/**
	* Subscribes a federate to the StartSnifferAttack interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartSnifferAttack:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the StartSnifferAttack interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	* (that is, the StartSnifferAttack interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the StartSnifferAttack interaction class).
	...
	*/
	...
	protected StartSnifferAttack( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected StartSnifferAttack( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the StartSnifferAttack interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new StartSnifferAttack interaction class instance
	*/
	public StartSnifferAttack( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #StartSnifferAttack( ReceivedInteraction datamemberMap )}, except this
	* new StartSnifferAttack interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new StartSnifferAttack interaction class instance
	* @param logicalTime timestamp for this new StartSnifferAttack interaction class
	* instance
	*/
	public StartSnifferAttack( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new StartSnifferAttack interaction class instance that is a duplicate
	* of the instance referred to by StartSnifferAttack_var.
	*
	* @param StartSnifferAttack_var StartSnifferAttack interaction class instance of which
	* this newly created StartSnifferAttack interaction class instance will be a
	* duplicate
	*/
	public StartSnifferAttack( StartSnifferAttack StartSnifferAttack_var ) {
		super( StartSnifferAttack_var );
		
		
		set_listenerNodeFullPath( StartSnifferAttack_var.get_listenerNodeFullPath() );
		set_listenerInterface( StartSnifferAttack_var.get_listenerInterface() );
		set_nodeFullPath( StartSnifferAttack_var.get_nodeFullPath() );
	}
	...
	*/
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof StartSnifferAttack ) {
			StartSnifferAttack data = (StartSnifferAttack)object;
