...
/**
* The StartNetworkIPFirewall class implements the StartNetworkIPFirewall interaction in the
* MapperEx simulation.
*/
public class StartNetworkIPFirewall extends OmnetCommand {

	/**
	* Default constructor -- creates an instance of the StartNetworkIPFirewall interaction
	* class with default parameter values.
	*/
	public StartNetworkIPFirewall() { }
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the StartNetworkIPFirewall interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the StartNetworkIPFirewall
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the StartNetworkIPFirewall interaction class.
	*/
	public static String get_simple_class_name() { return "StartNetworkIPFirewall"; }
	...
	* StartNetworkIPFirewall interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall" );
		_classNameClassMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall", StartNetworkIPFirewall.class );
		
		_datamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall", _datamemberNames );
		_allDatamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall", _allDatamemberNames );
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall:  could not initialize:  ";
	protected static void init( RTIambassador rti ) {
		...
		while( isNotInitialized ) {
			try {
				_handle = rti.getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall" );
		...
		_classNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall", get_handle() );
		_classHandleNameMap.put( get_handle(), "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall" );
		_classHandleSimpleNameMap.put( get_handle(), "StartNetworkIPFirewall" );
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall,dstNetworkAddress", get_dstNetworkAddress_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall,srcNetworkAddress", get_srcNetworkAddress_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall,nodeFullPath", get_nodeFullPath_handle() );
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall:  could not publish:  ";

	/**
	* Publishes the StartNetworkIPFirewall interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall:  could not unpublish:  ";
	/**
	* Unpublishes the StartNetworkIPFirewall interaction class for a federate.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall:  could not subscribe:  ";
	/**
	* Subscribes a federate to the StartNetworkIPFirewall interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkIPFirewall:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the StartNetworkIPFirewall interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	* (that is, the StartNetworkIPFirewall interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the StartNetworkIPFirewall interaction class).
	...
	*/
	...
	protected StartNetworkIPFirewall( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected StartNetworkIPFirewall( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the StartNetworkIPFirewall interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new StartNetworkIPFirewall interaction class instance
	*/
	public StartNetworkIPFirewall( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #StartNetworkIPFirewall( ReceivedInteraction datamemberMap )}, except this
	* new StartNetworkIPFirewall interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new StartNetworkIPFirewall interaction class instance
	* @param logicalTime timestamp for this new StartNetworkIPFirewall interaction class
	* instance
	*/
	public StartNetworkIPFirewall( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new StartNetworkIPFirewall interaction class instance that is a duplicate
	* of the instance referred to by StartNetworkIPFirewall_var.
	*
	* @param StartNetworkIPFirewall_var StartNetworkIPFirewall interaction class instance of which
	* this newly created StartNetworkIPFirewall interaction class instance will be a
	* duplicate
	*/
	public StartNetworkIPFirewall( StartNetworkIPFirewall StartNetworkIPFirewall_var ) {
		super( StartNetworkIPFirewall_var );
		
		
		set_dstNetworkAddress( StartNetworkIPFirewall_var.get_dstNetworkAddress() );
		set_srcNetworkAddress( StartNetworkIPFirewall_var.get_srcNetworkAddress() );
		set_nodeFullPath( StartNetworkIPFirewall_var.get_nodeFullPath() );
	}
	...
	*/
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof StartNetworkIPFirewall ) {
			StartNetworkIPFirewall data = (StartNetworkIPFirewall)object;
