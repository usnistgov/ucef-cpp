...
public class NetworkPacket extends ActionBase {
	...
	*/
	public Object getParameter( String datamemberName ) {
		...
		if (  "packetType".equals( datamemberName )  ) return get_packetType();
		else if (  "receiverHost".equals( datamemberName )  ) return get_receiverHost();
		else if (  "data".equals( datamemberName )  ) return get_data();
	...
	*/
	public Object getParameter( int datamemberHandle ) {
		...
		if ( get_packetType_handle() == datamemberHandle ) return get_packetType();
		else if ( get_receiverHost_handle() == datamemberHandle ) return get_receiverHost();
		else if ( get_data_handle() == datamemberHandle ) return get_data();
	...
	protected boolean setParameterAux( int param_handle, String val ) {
		...
		if ( param_handle == get_packetType_handle() ) set_packetType( val );
		else if ( param_handle == get_receiverHost_handle() ) set_receiverHost( val );
		else if ( param_handle == get_data_handle() ) set_data( val );
	...
	protected boolean setParameterAux( String datamemberName, String val ) {
		...
		if (  "packetType".equals( datamemberName )  ) set_packetType( val );
		else if (  "receiverHost".equals( datamemberName )  ) set_receiverHost( val );
		else if (  "data".equals( datamemberName )  ) set_data( val );
	...
	protected boolean setParameterAux( String datamemberName, Object val ) {
		...
		if (  "packetType".equals( datamemberName )  ) set_packetType( (String)val );
		else if (  "receiverHost".equals( datamemberName )  ) set_receiverHost( (String)val );
		else if (  "data".equals( datamemberName )  ) set_data( (String)val );
