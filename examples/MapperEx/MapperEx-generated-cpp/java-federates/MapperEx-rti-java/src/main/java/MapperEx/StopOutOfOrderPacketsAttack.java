...
/**
* The StopOutOfOrderPacketsAttack class implements the StopOutOfOrderPacketsAttack interaction in the
* MapperEx simulation.
*/
public class StopOutOfOrderPacketsAttack extends OmnetCommand {

	/**
	* Default constructor -- creates an instance of the StopOutOfOrderPacketsAttack interaction
	* class with default parameter values.
	*/
	public StopOutOfOrderPacketsAttack() { }
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the StopOutOfOrderPacketsAttack interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the StopOutOfOrderPacketsAttack
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the StopOutOfOrderPacketsAttack interaction class.
	*/
	public static String get_simple_class_name() { return "StopOutOfOrderPacketsAttack"; }
	...
	* StopOutOfOrderPacketsAttack interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack" );
		_classNameClassMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack", StopOutOfOrderPacketsAttack.class );
		
		_datamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack", _datamemberNames );
		_allDatamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack", _allDatamemberNames );
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack:  could not initialize:  ";
	protected static void init( RTIambassador rti ) {
		...
		while( isNotInitialized ) {
			try {
				_handle = rti.getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack" );
		...
		_classNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack", get_handle() );
		_classHandleNameMap.put( get_handle(), "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack" );
		_classHandleSimpleNameMap.put( get_handle(), "StopOutOfOrderPacketsAttack" );
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack,dstNetworkAddress", get_dstNetworkAddress_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack,srcNetworkAddress", get_srcNetworkAddress_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack,recordingNodeFullPath", get_recordingNodeFullPath_handle() );
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack:  could not publish:  ";

	/**
	* Publishes the StopOutOfOrderPacketsAttack interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack:  could not unpublish:  ";
	/**
	* Unpublishes the StopOutOfOrderPacketsAttack interaction class for a federate.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack:  could not subscribe:  ";
	/**
	* Subscribes a federate to the StopOutOfOrderPacketsAttack interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the StopOutOfOrderPacketsAttack interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	* (that is, the StopOutOfOrderPacketsAttack interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the StopOutOfOrderPacketsAttack interaction class).
	...
	*/
	...
	public String toString() {
		return "StopOutOfOrderPacketsAttack("
	...
	*/
	...
	protected StopOutOfOrderPacketsAttack( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected StopOutOfOrderPacketsAttack( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the StopOutOfOrderPacketsAttack interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new StopOutOfOrderPacketsAttack interaction class instance
	*/
	public StopOutOfOrderPacketsAttack( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #StopOutOfOrderPacketsAttack( ReceivedInteraction datamemberMap )}, except this
	* new StopOutOfOrderPacketsAttack interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new StopOutOfOrderPacketsAttack interaction class instance
	* @param logicalTime timestamp for this new StopOutOfOrderPacketsAttack interaction class
	* instance
	*/
	public StopOutOfOrderPacketsAttack( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new StopOutOfOrderPacketsAttack interaction class instance that is a duplicate
	* of the instance referred to by StopOutOfOrderPacketsAttack_var.
	*
	* @param StopOutOfOrderPacketsAttack_var StopOutOfOrderPacketsAttack interaction class instance of which
	* this newly created StopOutOfOrderPacketsAttack interaction class instance will be a
	* duplicate
	*/
	public StopOutOfOrderPacketsAttack( StopOutOfOrderPacketsAttack StopOutOfOrderPacketsAttack_var ) {
		super( StopOutOfOrderPacketsAttack_var );
		
		
		set_dstNetworkAddress( StopOutOfOrderPacketsAttack_var.get_dstNetworkAddress() );
		set_srcNetworkAddress( StopOutOfOrderPacketsAttack_var.get_srcNetworkAddress() );
		set_recordingNodeFullPath( StopOutOfOrderPacketsAttack_var.get_recordingNodeFullPath() );
	}
	...
	*/
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof StopOutOfOrderPacketsAttack ) {
			StopOutOfOrderPacketsAttack data = (StopOutOfOrderPacketsAttack)object;
