...
/**
* The StartNetworkFilterAttack class implements the StartNetworkFilterAttack interaction in the
* TESDemoIntegrationModel simulation.
*/
public class StartNetworkFilterAttack extends OmnetCommand {

	/**
	* Default constructor -- creates an instance of the StartNetworkFilterAttack interaction
	* class with default parameter values.
	*/
	public StartNetworkFilterAttack() { }
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the StartNetworkFilterAttack interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the StartNetworkFilterAttack
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the StartNetworkFilterAttack interaction class.
	*/
	public static String get_simple_class_name() { return "StartNetworkFilterAttack"; }
	...
	* StartNetworkFilterAttack interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack" );
		_classNameClassMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack", StartNetworkFilterAttack.class );
		
		_datamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack", _datamemberNames );
		_allDatamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack", _allDatamemberNames );
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack:  could not initialize:  ";
	protected static void init( RTIambassador rti ) {
		...
		while( isNotInitialized ) {
			try {
				_handle = rti.getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack" );
		...
		_classNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack", get_handle() );
		_classHandleNameMap.put( get_handle(), "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack" );
		_classHandleSimpleNameMap.put( get_handle(), "StartNetworkFilterAttack" );
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack,dstNetworkAddress", get_dstNetworkAddress_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack,srcNetworkAddress", get_srcNetworkAddress_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack,recordingNodeFullPath", get_recordingNodeFullPath_handle() );
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack:  could not publish:  ";

	/**
	* Publishes the StartNetworkFilterAttack interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack:  could not unpublish:  ";
	/**
	* Unpublishes the StartNetworkFilterAttack interaction class for a federate.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack:  could not subscribe:  ";
	/**
	* Subscribes a federate to the StartNetworkFilterAttack interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartNetworkFilterAttack:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the StartNetworkFilterAttack interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	* (that is, the StartNetworkFilterAttack interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the StartNetworkFilterAttack interaction class).
	...
	*/
	...
	public String toString() {
		return "StartNetworkFilterAttack("
	...
	*/
	...
	protected StartNetworkFilterAttack( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected StartNetworkFilterAttack( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the StartNetworkFilterAttack interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new StartNetworkFilterAttack interaction class instance
	*/
	public StartNetworkFilterAttack( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #StartNetworkFilterAttack( ReceivedInteraction datamemberMap )}, except this
	* new StartNetworkFilterAttack interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new StartNetworkFilterAttack interaction class instance
	* @param logicalTime timestamp for this new StartNetworkFilterAttack interaction class
	* instance
	*/
	public StartNetworkFilterAttack( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new StartNetworkFilterAttack interaction class instance that is a duplicate
	* of the instance referred to by StartNetworkFilterAttack_var.
	*
	* @param StartNetworkFilterAttack_var StartNetworkFilterAttack interaction class instance of which
	* this newly created StartNetworkFilterAttack interaction class instance will be a
	* duplicate
	*/
	public StartNetworkFilterAttack( StartNetworkFilterAttack StartNetworkFilterAttack_var ) {
		super( StartNetworkFilterAttack_var );
		
		
		set_dstNetworkAddress( StartNetworkFilterAttack_var.get_dstNetworkAddress() );
		set_srcNetworkAddress( StartNetworkFilterAttack_var.get_srcNetworkAddress() );
		set_recordingNodeFullPath( StartNetworkFilterAttack_var.get_recordingNodeFullPath() );
	}
	...
	*/
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof StartNetworkFilterAttack ) {
			StartNetworkFilterAttack data = (StartNetworkFilterAttack)object;
