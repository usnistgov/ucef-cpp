...
/**
* The CeaseReplayAttack class implements the CeaseReplayAttack interaction in the
* TESDemoIntegrationModel simulation.
*/
public class CeaseReplayAttack extends OmnetCommand {

	/**
	* Default constructor -- creates an instance of the CeaseReplayAttack interaction
	* class with default parameter values.
	*/
	public CeaseReplayAttack() { }
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the CeaseReplayAttack interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the CeaseReplayAttack
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the CeaseReplayAttack interaction class.
	*/
	public static String get_simple_class_name() { return "CeaseReplayAttack"; }
	...
	* CeaseReplayAttack interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack" );
		_classNameClassMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack", CeaseReplayAttack.class );
		
		_datamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack", _datamemberNames );
		_allDatamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack", _allDatamemberNames );
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack:  could not initialize:  ";
	protected static void init( RTIambassador rti ) {
		...
		while( isNotInitialized ) {
			try {
				_handle = rti.getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack" );
		...
		_classNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack", get_handle() );
		_classHandleNameMap.put( get_handle(), "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack" );
		_classHandleSimpleNameMap.put( get_handle(), "CeaseReplayAttack" );
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack,dstNetworkAddress", get_dstNetworkAddress_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack,srcNetworkAddress", get_srcNetworkAddress_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack,recordingNodeFullPath", get_recordingNodeFullPath_handle() );
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack:  could not publish:  ";

	/**
	* Publishes the CeaseReplayAttack interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack:  could not unpublish:  ";
	/**
	* Unpublishes the CeaseReplayAttack interaction class for a federate.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack:  could not subscribe:  ";
	/**
	* Subscribes a federate to the CeaseReplayAttack interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the CeaseReplayAttack interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	* (that is, the CeaseReplayAttack interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the CeaseReplayAttack interaction class).
	...
	*/
	...
	protected CeaseReplayAttack( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected CeaseReplayAttack( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the CeaseReplayAttack interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new CeaseReplayAttack interaction class instance
	*/
	public CeaseReplayAttack( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #CeaseReplayAttack( ReceivedInteraction datamemberMap )}, except this
	* new CeaseReplayAttack interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new CeaseReplayAttack interaction class instance
	* @param logicalTime timestamp for this new CeaseReplayAttack interaction class
	* instance
	*/
	public CeaseReplayAttack( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new CeaseReplayAttack interaction class instance that is a duplicate
	* of the instance referred to by CeaseReplayAttack_var.
	*
	* @param CeaseReplayAttack_var CeaseReplayAttack interaction class instance of which
	* this newly created CeaseReplayAttack interaction class instance will be a
	* duplicate
	*/
	public CeaseReplayAttack( CeaseReplayAttack CeaseReplayAttack_var ) {
		super( CeaseReplayAttack_var );
		
		
		set_dstNetworkAddress( CeaseReplayAttack_var.get_dstNetworkAddress() );
		set_srcNetworkAddress( CeaseReplayAttack_var.get_srcNetworkAddress() );
		set_recordingNodeFullPath( CeaseReplayAttack_var.get_recordingNodeFullPath() );
	}
	...
	*/
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof CeaseReplayAttack ) {
			CeaseReplayAttack data = (CeaseReplayAttack)object;
