...
*/
public class GridlabDInput extends  {
	...
	*/
	public static String get_class_name() { return "GridlabDInput"; }
	...
	*/
	...
	static {
		_classNameSet.add( "GridlabDInput" );
		_classNameClassMap.put( "GridlabDInput", GridlabDInput.class );
		
		_datamemberClassNameSetMap.put( "GridlabDInput", _datamemberNames );
		_allDatamemberClassNameSetMap.put( "GridlabDInput", _allDatamemberNames );
	...
	private static String initErrorMessage = "Error:  GridlabDInput:  could not initialize:  ";
	protected static void init( RTIambassador rti ) {
		...
		while( isNotInitialized ) {
			try {
				_handle = rti.getInteractionClassHandle( "GridlabDInput" );
		...
		_classNameHandleMap.put( "GridlabDInput", get_handle() );
		_classHandleNameMap.put( get_handle(), "GridlabDInput" );
		...
		_datamemberNameHandleMap.put( "GridlabDInput,Units", get_Units_handle() );
		_datamemberNameHandleMap.put( "GridlabDInput,ModelName", get_ModelName_handle() );
		_datamemberNameHandleMap.put( "GridlabDInput,ObjectName", get_ObjectName_handle() );
		_datamemberNameHandleMap.put( "GridlabDInput,Value", get_Value_handle() );
		_datamemberNameHandleMap.put( "GridlabDInput,Operation", get_Operation_handle() );
		_datamemberNameHandleMap.put( "GridlabDInput,Parameter", get_Parameter_handle() );
	...
	private static String publishErrorMessage = "Error:  GridlabDInput:  could not publish:  ";
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  GridlabDInput:  could not unpublish:  ";
	/**
	...
	*/
	...
	private static String subscribeErrorMessage = "Error:  GridlabDInput:  could not subscribe:  ";
	/**
	...
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  GridlabDInput:  could not unsubscribe:  ";
	/**
