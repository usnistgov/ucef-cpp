...
/**
* The TerminateReplayAttack class implements the TerminateReplayAttack interaction in the
* TESDemoIntegrationModel simulation.
*/
public class TerminateReplayAttack extends OmnetCommand {

	/**
	* Default constructor -- creates an instance of the TerminateReplayAttack interaction
	* class with default parameter values.
	*/
	public TerminateReplayAttack() { }
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the TerminateReplayAttack interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the TerminateReplayAttack
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the TerminateReplayAttack interaction class.
	*/
	public static String get_simple_class_name() { return "TerminateReplayAttack"; }
	...
	* TerminateReplayAttack interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack" );
		_classNameClassMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack", TerminateReplayAttack.class );
		
		_datamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack", _datamemberNames );
		_allDatamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack", _allDatamemberNames );
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack:  could not initialize:  ";
	protected static void init( RTIambassador rti ) {
		...
		while( isNotInitialized ) {
			try {
				_handle = rti.getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack" );
		...
		_classNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack", get_handle() );
		_classHandleNameMap.put( get_handle(), "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack" );
		_classHandleSimpleNameMap.put( get_handle(), "TerminateReplayAttack" );
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack,dstNetworkAddress", get_dstNetworkAddress_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack,srcNetworkAddress", get_srcNetworkAddress_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack,recordingNodeFullPath", get_recordingNodeFullPath_handle() );
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack:  could not publish:  ";

	/**
	* Publishes the TerminateReplayAttack interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack:  could not unpublish:  ";
	/**
	* Unpublishes the TerminateReplayAttack interaction class for a federate.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack:  could not subscribe:  ";
	/**
	* Subscribes a federate to the TerminateReplayAttack interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.TerminateReplayAttack:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the TerminateReplayAttack interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	* (that is, the TerminateReplayAttack interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the TerminateReplayAttack interaction class).
	...
	*/
	...
	protected TerminateReplayAttack( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected TerminateReplayAttack( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the TerminateReplayAttack interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new TerminateReplayAttack interaction class instance
	*/
	public TerminateReplayAttack( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #TerminateReplayAttack( ReceivedInteraction datamemberMap )}, except this
	* new TerminateReplayAttack interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new TerminateReplayAttack interaction class instance
	* @param logicalTime timestamp for this new TerminateReplayAttack interaction class
	* instance
	*/
	public TerminateReplayAttack( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new TerminateReplayAttack interaction class instance that is a duplicate
	* of the instance referred to by TerminateReplayAttack_var.
	*
	* @param TerminateReplayAttack_var TerminateReplayAttack interaction class instance of which
	* this newly created TerminateReplayAttack interaction class instance will be a
	* duplicate
	*/
	public TerminateReplayAttack( TerminateReplayAttack TerminateReplayAttack_var ) {
		super( TerminateReplayAttack_var );
		
		
		set_dstNetworkAddress( TerminateReplayAttack_var.get_dstNetworkAddress() );
		set_srcNetworkAddress( TerminateReplayAttack_var.get_srcNetworkAddress() );
		set_recordingNodeFullPath( TerminateReplayAttack_var.get_recordingNodeFullPath() );
	}
	...
	*/
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof TerminateReplayAttack ) {
			TerminateReplayAttack data = (TerminateReplayAttack)object;
