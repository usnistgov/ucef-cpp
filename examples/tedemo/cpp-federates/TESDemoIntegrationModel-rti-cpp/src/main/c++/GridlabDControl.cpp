...
void GridlabDControl::init( RTI::RTIambassador *rti ) {
	...
	while( isNotInitialized ) {
		try {
			getHandle() = rti->getInteractionClassHandle( "GridlabDControl" );
...
std::ostream &operator<<( std::ostream &os, const GridlabDControl &entity ) {
	return os << "GridlabDControl("  << "IsControl:" << entity.get_IsControl() << ", " << "Units:" << entity.get_Units() << ", " << "ModelName:" << entity.get_ModelName() << ", " << "Period:" << entity.get_Period() << ", " << "ObjectName:" << entity.get_ObjectName() << ", " << "Value:" << entity.get_Value() << ", " << "Operation:" << entity.get_Operation() << ", " << "Parameter:" << entity.get_Parameter()	<< ")";
}
