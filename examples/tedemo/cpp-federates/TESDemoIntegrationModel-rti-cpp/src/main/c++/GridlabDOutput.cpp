...
void GridlabDOutput::init( RTI::RTIambassador *rti ) {
	...
	while( isNotInitialized ) {
		try {
			getHandle() = rti->getInteractionClassHandle( "GridlabDOutput" );
...
std::ostream &operator<<( std::ostream &os, const GridlabDOutput &entity ) {
	return os << "GridlabDOutput("  << "Units:" << entity.get_Units() << ", " << "ModelName:" << entity.get_ModelName() << ", " << "ObjectName:" << entity.get_ObjectName() << ", " << "Value:" << entity.get_Value() << ", " << "Operation:" << entity.get_Operation() << ", " << "Parameter:" << entity.get_Parameter()	<< ")";
}
