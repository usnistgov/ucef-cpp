...
void CeaseReplayAttack::init( RTI::RTIambassador *rti ) {
	...
	while( isNotInitialized ) {
		try {
			getHandle() = rti->getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.CeaseReplayAttack" );
	...
	getClassNameHandleMap().insert(  std::make_pair( "CeaseReplayAttack", get_handle() )  );
	getClassHandleNameMap().insert(  std::make_pair( get_handle(), "CeaseReplayAttack" )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "CeaseReplayAttack,dstNetworkAddress", get_dstNetworkAddress_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "CeaseReplayAttack,srcNetworkAddress", get_srcNetworkAddress_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "CeaseReplayAttack,recordingNodeFullPath", get_recordingNodeFullPath_handle() )  );
...
void CeaseReplayAttack::publish( RTI::RTIambassador *rti ) {
	if ( getIsPublished() ) {
		return;
	}
...
void CeaseReplayAttack::unpublish( RTI::RTIambassador *rti ) {
	if ( !getIsPublished() ) {
		return;
	}
...
void CeaseReplayAttack::subscribe( RTI::RTIambassador *rti ) {
	if ( getIsSubscribed() ) {
		return;
	}
...
void CeaseReplayAttack::unsubscribe( RTI::RTIambassador *rti ) {
	if ( !getIsSubscribed() ) {
		return;
	}
...
bool CeaseReplayAttack::static_init( void ) {
	static bool isInitialized = false;
	if ( isInitialized ) {
		return true;
	}
	...
	getClassNameSet().insert( "CeaseReplayAttack" );
	
	getClassNameFactoryMap().insert(  std::make_pair( "CeaseReplayAttack", &CeaseReplayAttack::factory )  );
	getClassNamePublishMap().insert(   std::make_pair(  "CeaseReplayAttack", (PubsubFunctionPtr)( &CeaseReplayAttack::publish )  )   );
	getClassNameUnpublishMap().insert(   std::make_pair(  "CeaseReplayAttack", (PubsubFunctionPtr)( &CeaseReplayAttack::unpublish )  )   );
	getClassNameSubscribeMap().insert(   std::make_pair(  "CeaseReplayAttack", (PubsubFunctionPtr)( &CeaseReplayAttack::subscribe )  )   );
	getClassNameUnsubscribeMap().insert(   std::make_pair(  "CeaseReplayAttack", (PubsubFunctionPtr)( &CeaseReplayAttack::unsubscribe )  )   );

	getDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "CeaseReplayAttack", &getDatamemberNames() )  );
	getAllDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "CeaseReplayAttack", &getAllDatamemberNames() )  );
...
CeaseReplayAttack::ParameterHandleValuePairSetSP CeaseReplayAttack::createDatamemberHandleValuePairSet( RTI::ULong count ) {
