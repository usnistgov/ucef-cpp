...
std::ostream &operator<<( std::ostream &os, const StartDelayNodeAttack &entity ) {
	return os << "StartDelayNodeAttack("  << "sourceFed:" << entity.get_sourceFed() << ", " << "uniqueCommandID:" << entity.get_uniqueCommandID() << ", " << "delayMean:" << entity.get_delayMean() << ", " << "nodeFullPath:" << entity.get_nodeFullPath() << ", " << "originFed:" << entity.get_originFed() << ", " << "delayStdDev:" << entity.get_delayStdDev() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
