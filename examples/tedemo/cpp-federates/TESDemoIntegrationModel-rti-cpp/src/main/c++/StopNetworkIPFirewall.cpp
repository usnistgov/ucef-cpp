...
void StopNetworkIPFirewall::init( RTI::RTIambassador *rti ) {
	...
	while( isNotInitialized ) {
		try {
			getHandle() = rti->getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopNetworkIPFirewall" );
	...
	getClassNameHandleMap().insert(  std::make_pair( "StopNetworkIPFirewall", get_handle() )  );
	getClassHandleNameMap().insert(  std::make_pair( get_handle(), "StopNetworkIPFirewall" )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StopNetworkIPFirewall,dstNetworkAddress", get_dstNetworkAddress_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StopNetworkIPFirewall,srcNetworkAddress", get_srcNetworkAddress_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StopNetworkIPFirewall,nodeFullPath", get_nodeFullPath_handle() )  );
...
void StopNetworkIPFirewall::publish( RTI::RTIambassador *rti ) {
	if ( getIsPublished() ) {
		return;
	}
...
void StopNetworkIPFirewall::unpublish( RTI::RTIambassador *rti ) {
	if ( !getIsPublished() ) {
		return;
	}
...
void StopNetworkIPFirewall::subscribe( RTI::RTIambassador *rti ) {
	if ( getIsSubscribed() ) {
		return;
	}
...
void StopNetworkIPFirewall::unsubscribe( RTI::RTIambassador *rti ) {
	if ( !getIsSubscribed() ) {
		return;
	}
...
bool StopNetworkIPFirewall::static_init( void ) {
	static bool isInitialized = false;
	if ( isInitialized ) {
		return true;
	}
	...
	getClassNameSet().insert( "StopNetworkIPFirewall" );
	
	getClassNameFactoryMap().insert(  std::make_pair( "StopNetworkIPFirewall", &StopNetworkIPFirewall::factory )  );
	getClassNamePublishMap().insert(   std::make_pair(  "StopNetworkIPFirewall", (PubsubFunctionPtr)( &StopNetworkIPFirewall::publish )  )   );
	getClassNameUnpublishMap().insert(   std::make_pair(  "StopNetworkIPFirewall", (PubsubFunctionPtr)( &StopNetworkIPFirewall::unpublish )  )   );
	getClassNameSubscribeMap().insert(   std::make_pair(  "StopNetworkIPFirewall", (PubsubFunctionPtr)( &StopNetworkIPFirewall::subscribe )  )   );
	getClassNameUnsubscribeMap().insert(   std::make_pair(  "StopNetworkIPFirewall", (PubsubFunctionPtr)( &StopNetworkIPFirewall::unsubscribe )  )   );

	getDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "StopNetworkIPFirewall", &getDatamemberNames() )  );
	getAllDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "StopNetworkIPFirewall", &getAllDatamemberNames() )  );
...
StopNetworkIPFirewall::ParameterHandleValuePairSetSP StopNetworkIPFirewall::createDatamemberHandleValuePairSet( RTI::ULong count ) {
