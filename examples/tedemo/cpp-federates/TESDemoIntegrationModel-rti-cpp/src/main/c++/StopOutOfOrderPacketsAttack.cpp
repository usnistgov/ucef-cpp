...
void StopOutOfOrderPacketsAttack::init( RTI::RTIambassador *rti ) {
	...
	while( isNotInitialized ) {
		try {
			getHandle() = rti->getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StopOutOfOrderPacketsAttack" );
	...
	getClassNameHandleMap().insert(  std::make_pair( "StopOutOfOrderPacketsAttack", get_handle() )  );
	getClassHandleNameMap().insert(  std::make_pair( get_handle(), "StopOutOfOrderPacketsAttack" )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StopOutOfOrderPacketsAttack,dstNetworkAddress", get_dstNetworkAddress_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StopOutOfOrderPacketsAttack,srcNetworkAddress", get_srcNetworkAddress_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StopOutOfOrderPacketsAttack,recordingNodeFullPath", get_recordingNodeFullPath_handle() )  );
...
void StopOutOfOrderPacketsAttack::publish( RTI::RTIambassador *rti ) {
	if ( getIsPublished() ) {
		return;
	}
...
void StopOutOfOrderPacketsAttack::unpublish( RTI::RTIambassador *rti ) {
	if ( !getIsPublished() ) {
		return;
	}
...
void StopOutOfOrderPacketsAttack::subscribe( RTI::RTIambassador *rti ) {
	if ( getIsSubscribed() ) {
		return;
	}
...
void StopOutOfOrderPacketsAttack::unsubscribe( RTI::RTIambassador *rti ) {
	if ( !getIsSubscribed() ) {
		return;
	}
...
bool StopOutOfOrderPacketsAttack::static_init( void ) {
	static bool isInitialized = false;
	if ( isInitialized ) {
		return true;
	}
	...
	getClassNameSet().insert( "StopOutOfOrderPacketsAttack" );
	
	getClassNameFactoryMap().insert(  std::make_pair( "StopOutOfOrderPacketsAttack", &StopOutOfOrderPacketsAttack::factory )  );
	getClassNamePublishMap().insert(   std::make_pair(  "StopOutOfOrderPacketsAttack", (PubsubFunctionPtr)( &StopOutOfOrderPacketsAttack::publish )  )   );
	getClassNameUnpublishMap().insert(   std::make_pair(  "StopOutOfOrderPacketsAttack", (PubsubFunctionPtr)( &StopOutOfOrderPacketsAttack::unpublish )  )   );
	getClassNameSubscribeMap().insert(   std::make_pair(  "StopOutOfOrderPacketsAttack", (PubsubFunctionPtr)( &StopOutOfOrderPacketsAttack::subscribe )  )   );
	getClassNameUnsubscribeMap().insert(   std::make_pair(  "StopOutOfOrderPacketsAttack", (PubsubFunctionPtr)( &StopOutOfOrderPacketsAttack::unsubscribe )  )   );

	getDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "StopOutOfOrderPacketsAttack", &getDatamemberNames() )  );
	getAllDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "StopOutOfOrderPacketsAttack", &getAllDatamemberNames() )  );
...
StopOutOfOrderPacketsAttack::ParameterHandleValuePairSetSP StopOutOfOrderPacketsAttack::createDatamemberHandleValuePairSet( RTI::ULong count ) {
