...
std::ostream &operator<<( std::ostream &os, const StopNodeAttack &entity ) {
	return os << "StopNodeAttack("  << "sourceFed:" << entity.get_sourceFed() << ", " << "uniqueCommandID:" << entity.get_uniqueCommandID() << ", " << "recordingNodeFullPath:" << entity.get_recordingNodeFullPath() << ", " << "originFed:" << entity.get_originFed() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
