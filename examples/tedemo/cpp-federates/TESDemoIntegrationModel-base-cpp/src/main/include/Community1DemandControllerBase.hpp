#ifndef _Community1DemandControllerBase_
#define _Community1DemandControllerBase_
...
class Community1DemandControllerBase : public SynchronizedFederate {
...
public:
	...
	virtual ~Community1DemandControllerBase( void )
	...
	void init( ArgVector argVector ) {
		...
		// object pubsub
         ...
         if( argVector.size() > 2 ){
			...
			GridlabDInput::enablePublishLog("GridlabDInput", "Community1DemandController", "NORMAL", loglevel);  
			
			
			GridlabDOutput::enableSubscribeLog("GridlabDOutput", "Community1DemandController", "NORMAL", loglevel);  
...
public:	
	// default constructor
	Community1DemandControllerBase( void ) { }
	
	// constructor
	Community1DemandControllerBase( const std::string &federation_id, const std::string &federate_id ) { init( federation_id, federate_id ); }

	// constructor	
	Community1DemandControllerBase( int argc, char *argv[] ) { init( argc, argv ); }
