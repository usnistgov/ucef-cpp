#ifndef _Community2DemandControllerBase_
#define _Community2DemandControllerBase_
...
class Community2DemandControllerBase : public SynchronizedFederate {
...
public:
	...
	virtual ~Community2DemandControllerBase( void )
	...
	void init( ArgVector argVector ) {
		...
		// object pubsub
         ...
         if( argVector.size() > 2 ){
			...
			GridlabDInput::enablePublishLog("GridlabDInput", "Community2DemandController", "NORMAL", loglevel);  
			
			
			GridlabDOutput::enableSubscribeLog("GridlabDOutput", "Community2DemandController", "NORMAL", loglevel);  
...
public:	
	// default constructor
	Community2DemandControllerBase( void ) { }
	
	// constructor
	Community2DemandControllerBase( const std::string &federation_id, const std::string &federate_id ) { init( federation_id, federate_id ); }

	// constructor	
	Community2DemandControllerBase( int argc, char *argv[] ) { init( argc, argv ); }
