...
std::ostream &operator<<( std::ostream &os, const C2WInteractionRoot &entity ) {
	return os << "C2WInteractionRoot("  << "sourceFed:" << entity.get_sourceFed() << ", " << "originFed:" << entity.get_originFed() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime() << ", " << "federateFilter:" << entity.get_federateFilter()	<< ")";
}
...
C2WInteractionRoot::ParameterHandleValuePairSetSP C2WInteractionRoot::createDatamemberHandleValuePairSet( RTI::ULong count ) {
