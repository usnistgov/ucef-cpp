...
std::ostream &operator<<( std::ostream &os, const HighPrio &entity ) {
	return os << "HighPrio("  << "Time:" << entity.get_Time() << ", " << "sourceFed:" << entity.get_sourceFed() << ", " << "FedName:" << entity.get_FedName() << ", " << "originFed:" << entity.get_originFed() << ", " << "Comment:" << entity.get_Comment() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime() << ", " << "federateFilter:" << entity.get_federateFilter()	<< ")";
}
...
HighPrio::ParameterHandleValuePairSetSP HighPrio::createDatamemberHandleValuePairSet( RTI::ULong count ) {
	ParameterHandleValuePairSetSP datamembers = Super::createDatamemberHandleValuePairSet( count + 7 );
