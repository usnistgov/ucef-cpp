...
std::ostream &operator<<( std::ostream &os, const SimResume &entity ) {
	return os << "SimResume("  << "sourceFed:" << entity.get_sourceFed() << ", " << "originFed:" << entity.get_originFed() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime() << ", " << "federateFilter:" << entity.get_federateFilter()	<< ")";
}
...
SimResume::ParameterHandleValuePairSetSP SimResume::createDatamemberHandleValuePairSet( RTI::ULong count ) {
