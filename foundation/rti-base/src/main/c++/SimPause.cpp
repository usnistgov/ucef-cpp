...
std::ostream &operator<<( std::ostream &os, const SimPause &entity ) {
	return os << "SimPause("  << "sourceFed:" << entity.get_sourceFed() << ", " << "originFed:" << entity.get_originFed() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime() << ", " << "federateFilter:" << entity.get_federateFilter()	<< ")";
}
...
SimPause::ParameterHandleValuePairSetSP SimPause::createDatamemberHandleValuePairSet( RTI::ULong count ) {
